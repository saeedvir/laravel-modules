...
use Saeedvir\Modules\Activators\FileActivator;
use Saeedvir\Modules\Providers\ConsoleServiceProvider;
...
return [
    ...
    */
    'stubs' => [
        'enabled' => false,
        'path' => base_path('vendor/saeedvir/laravel-modules/src/Commands/stubs'),
        'files' => [
        ...
        'replacements' => [
             ...
             *
             * 'composer' => [
             *      'CUSTOM_KEY' => fn (\Saeedvir\Modules\Generators\ModuleGenerator $generator) => $generator->getModule()->getLowerName() . '-module',
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'saeedvir'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Saeed Vir'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'saeedvir@example.com'),
        ],
    ...
    */
    'activators' => [
        ...
        'database' => [
            'class' => \Saeedvir\Modules\Activators\DatabaseActivator::class,
    ...
    |--------------------------------------------------------------------------
    |
    | Configuration for performance optimizations in large-scale applications
    |
    */
    'performance' => [
        'cache_ttl' => 3600,
