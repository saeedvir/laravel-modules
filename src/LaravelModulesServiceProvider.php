...
use Saeedvir\Modules\Exceptions\InvalidActivatorClass;
use Saeedvir\Modules\Support\Stub;
...
class LaravelModulesServiceProvider extends ModulesServiceProvider
{
    ...
    public function boot()
    {
        ...
        AboutCommand::add('Laravel-Modules', [
            'Version' => fn () => InstalledVersions::getPrettyVersion('saeedvir/laravel-modules'),
        ]);
    ...
    protected function registerMigrations(): void
    {
        ...
        $this->app->resolving(Migrator::class, function (Migrator $migrator) {
            ...
            collect(\Saeedvir\Modules\Facades\Module::allEnabled())
                ->each(function (\Saeedvir\Modules\Laravel\Module $module) use ($migration_path, $migrator) {
    ...
    protected function registerTranslations(): void
    {
        ...
        $this->callAfterResolving('translator', function (TranslatorContract $translator) {
            ...
            collect(\Saeedvir\Modules\Facades\Module::allEnabled())
                ->each(function (\Saeedvir\Modules\Laravel\Module $module) use ($translator) {
