...
namespace Saeedvir\Modules\Facades;

use Illuminate\Support\Facades\Facade;
use Saeedvir\Modules\Commands\Database\MigrateFreshCommand;
use Saeedvir\Modules\Commands\Database\MigrateRefreshCommand;
use Saeedvir\Modules\Commands\Database\MigrateResetCommand;

/**
 * @method static array all()
 * @method static array getCached()
 * @method static array scan()
 * @method static \Saeedvir\Modules\Collection toCollection()
 ...
 * @method static \Saeedvir\Modules\Module find(string $name)
 * @method static \Saeedvir\Modules\Module findOrFail(string $name)
