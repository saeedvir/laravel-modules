...
namespace Saeedvir\Modules\Commands\Make;

use Illuminate\Console\Command;
use Saeedvir\Modules\Exceptions\FileAlreadyExistException;
use Saeedvir\Modules\Generators\FileGenerator;
use Saeedvir\Modules\Module;
use Saeedvir\Modules\Traits\PathNamespace;
...
abstract class GeneratorCommand extends Command
{
     ...
     * Get class namespace.
     *
     * @param  \Saeedvir\Modules\Module  $module
     * @return string
     */
